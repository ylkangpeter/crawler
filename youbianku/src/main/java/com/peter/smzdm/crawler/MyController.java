...
public class MyController {
    ...
    public static String PATH = "/Users/kangyongliang262/Downloads/youbianku";

    public static int numberOfCrawlers = 10;

    public static int start = 1;

    public static int end = 1900000;
...
//        controller.addSeed("https://www.youbianku.cn/node/1?amp");
        ...
        String url = "https://www.youbianku.cn/node/";

        for (int i = start; i <= end; i++) {
            controller.addSeed(url + i + "?amp");
        }
